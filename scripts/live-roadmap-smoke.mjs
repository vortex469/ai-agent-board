...
function makeTask(index, agentType) {
  ...
  return {
    ...
    description: [
      ...
      '',
      'Only edit ROADMAP_SMOKE.md. Verify the file contains the new line. Perform a hostile review after the focused file check passes. No manual board movement is allowed.',
      'Your final task summary must include "Focused tests passed:" and "Hostile review passed:" evidence.',
    ].join('\n'),
    priority: 'medium',
